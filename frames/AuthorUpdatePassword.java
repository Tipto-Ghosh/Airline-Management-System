...
public class AuthorUpdatePassword extends JFrame implements ActionListener{
    ...
    public AuthorUpdatePassword(User u){
    ...
    public void actionPerformed(ActionEvent ae)
	{
		...
		if(command.equals(updateBtn.getText()))
		{
			...
			if((!currentPassPF.getText().isEmpty()) && (!newPassPF.getText().isEmpty()))
			{
				...
				if(currentPassPF.getText().equals(user.getPassword()))
				{
