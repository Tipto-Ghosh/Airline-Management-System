...
public class ClientPasswordUpdateFrame extends JFrame implements ActionListener{
    ...
    public ClientPasswordUpdateFrame(User u){
    ...
    public void actionPerformed(ActionEvent ae)
	{
		...
		{   
            ClientFrame cf = new ClientFrame(this.u);
